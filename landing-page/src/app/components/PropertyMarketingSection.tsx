...
import brochureScreenshot from "../../assets/property-marketing/brochure-screenshot.png";
import qrCodeImg from "../../assets/property-marketing/qr-code.png";
...
const included = [
  {
    icon: FileText,
    title: "Digital Property Brochure",
    description: "A beautifully designed, shareable brochure for every listing — ready to print or send digitally in just a few clicks.",
  },
  {
    icon: QrCode,
    title: "QR Code",
    description: "Every listing gets its own scannable QR code linking straight to its property website — perfect for signs, flyers, and open houses.",
  },
];

export function PropertyMarketingSection() {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      <div
        ...
        style={{ background: "linear-gradient(166deg, #EEF0FF 8%, #F6F7FA 92%)" }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="text-center lg:text-left">
              ...
              >
                Each listing website ships with a scannable QR Code and shareable digital brochure — print it or send it instantly.
              </p>
            </div>
              ...
              {included.map((feature, i) => (
                ...
                >
                  <div
                    ...
                    style={{ background: "linear-gradient(135deg, #008AD0, #0A3B95)" }}
                  >
          ...
          {/* Image side: brochure screenshot + QR code + "ONE CLICK" badge */}
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            animate={inView ? { opacity: 1, x: 0 } : {}}
          ...
          >
            <div className="relative w-full max-w-[240px] sm:max-w-sm mb-12 sm:mb-0">
              <img
                src={brochureScreenshot}
                alt="REConnect property brochure preview"
                className="w-full block shadow-2xl rounded-lg"
              />
              <img
                src={qrCodeImg}
                alt="Property QR code"
                className="absolute -bottom-4 -left-3 w-20 h-20 sm:-bottom-6 sm:-left-6 sm:w-32 sm:h-32 shadow-2xl rounded-lg"
              />
              <motion.div
                animate={{ y: [0, -8, 0] }}
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-4 justify-center mt-6 sm:mt-24"
        >
          <motion.a
          ...
          >
            ...
            Activate Your Marketing Package
          </motion.a>
          <motion.a
            href="https://staging-pro.reconnectapp.com/amp-detail/demo"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.98 }}
