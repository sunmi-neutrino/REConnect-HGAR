...
import { Globe, QrCode, ExternalLink } from "lucide-react";
import swlGraphic from "../../imports/swl-graphic.png";
...
const included = [
  ...
  {
    icon: QrCode,
    title: "QR Code & Brochure Included",
    description: "Each listing website comes with a ready-to-print QR code and digital brochure you can share instantly with clients.",
    gradient: "linear-gradient(135deg, #008AD0, #0A3B95)",
  },
];
          ...
          >
            <div className="relative max-w-md w-full">
              ...
              <motion.div
                ...
                className="absolute -top-5 -right-5 w-20 h-20 rounded-full flex flex-col items-center justify-center shadow-xl"
                style={{
                  background: "linear-gradient(135deg, #EE6D68, #B14DFF)",
                  border: "3px solid white",
                }}
              >
                <span className="text-white text-xs font-bold text-center leading-tight" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  1 Free<br />for<br />HGAR
                </span>
              </motion.div>
            </div>
          </motion.div>
